...
public class welcome extends javax.swing.JFrame {
    ...
    public welcome() {
      ...
      //  System.out.println(ysize);
        ...
        connectToDB ctbd = new connectToDB();
        ctbd.start();
        try{
            t.sleep(4000);
        }
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(1366, 867));

        kGradientPanel1.setFont(new java.awt.Font("Tahoma", 0, 48)); // NOI18N
...
class connectToDB extends Thread{
   @Override
   public void run(){
       try{
